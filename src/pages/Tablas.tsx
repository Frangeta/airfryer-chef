...
import { Search, Snowflake, Leaf, Repeat, RotateCw } from 'lucide-react';
...
export default function Tablas() {
  ...
  useEffect(() => {
    setLoading(true);
    repo
      .listFoods({ q: q || undefined, category: category ?? undefined, frozenOnly, freshOnly })
      .then(setFoods)
      .finally(() => setLoading(false));
  }, [q, category, frozenOnly, freshOnly]);
